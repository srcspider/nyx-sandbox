...
/**
 * This exception is thrown every time a feature crutial to execution 
 * is missing, behaving strangely or outdated. 
 */
class Exception_MissingFeature {
...
/**
 * Aliases for WebGLRenderingContext constants, because they are used very very
 * often and god damn is that a long ass name to write.
 * 
 * At the time of this writing Dart does not support any other way of aliasing
 * the constants.
 */
class GL {
